...
namespace Sistema_de_Ventas
{
    ...
    {
        string newpass, newuser, newcargo, connectionString = "Server=MSI\\SQLEXPRESS;Database=BDTIENDA;Trusted_Connection=True;";
        ...
        void consultarcargo()
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    using (SqlCommand cmdObtenerCargo = new SqlCommand(queryObtenerCuenta, conn))
                    {
        ...
        void llenarusuario()
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    using (SqlCommand cmdQueryLlenarCbxUsuario = new SqlCommand(queryllenarcbxUsuario, conn))
                    {
                        conn.Open();
                        SqlDataReader reader = cmdQueryLlenarCbxUsuario.ExecuteReader();
        ...
        void actualizarpass()
        {
            ...
            string queryCambiarUserPassCargo = "UPDATE Usuarios SET Usuario = @usuario, Contraseña = @pass WHERE Cuenta = @cuenta";
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand cmdCambiarUserPassCargo = new SqlCommand(queryCambiarUserPassCargo, conn))
                    {
