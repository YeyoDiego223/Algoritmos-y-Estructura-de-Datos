    ...
    public partial class FormPrincipal : Form
    {
        ...
        void condicionales()
        {
            if (Form1.cargo == "Administrador")
            {
                ...
                pctbxVentas.Image = ConvertToGrayscale(Image.FromFile("Resources\\pcbxVentas.png"));
                pctbxDetalleVenta.Enabled = false;
                pctbxDetalleVenta.Image = ConvertToGrayscale(Image.FromFile("Resources\\pcbxDetalleVenta.png"));
                pctbxCompras.Enabled = false;
                pctbxCompras.Image = ConvertToGrayscale(Image.FromFile("Resources\\pcbxCompras.png"));
            }
            else if (Form1.cargo == "Cajero")
            {                
                pctbxClientes.Enabled = false;
                pctbxClientes.Image = ConvertToGrayscale(Image.FromFile("Resources\\pcbxClientes.png"));
                pctbxDetalleVenta.Enabled = false;
                pctbxDetalleVenta.Image = ConvertToGrayscale(Image.FromFile("Resources\\pcbxDetalleVenta.png"));
                pctbxCompras.Enabled = false;
                pctbxCompras.Image = ConvertToGrayscale(Image.FromFile("Resources\\pcbxCompras.png"));
                pctbxProveedores.Enabled = false;
                pctbxProveedores.Image = ConvertToGrayscale(Image.FromFile("Resources\\pcbxProveedores.png"));
                pctbxProductos.Enabled = false;
                pctbxProductos.Image = ConvertToGrayscale(Image.FromFile("Resources\\pcbxProductos.png"));
            }
        }
