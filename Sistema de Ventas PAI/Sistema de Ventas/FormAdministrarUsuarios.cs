...
namespace Sistema_de_Ventas
{
    ...
    {
        int posicion, cuenta;
        string cargo, usuario, pass, connectionString = ConfigurationManager.ConnectionStrings["SQLiteDB"].ConnectionString;
        ...
        {
            // Consulta SQL
            string query = "Select Cuenta, Cargo, Usuario, Contrasena FROM Usuarios";
                ...
                try
                {
                    ...
                    {                       
                        while (reader.Read())
                        {
                            ...
                            dgvDetalle.Rows[rowIndex].Cells["colPass"].Value = reader["Contrasena"];
                        }
                    }
                }
                catch (Exception ex)
        ...
        void agregarbase()
        {
            ...
            int newID = lastID + 1;
            string query = "INSERT INTO Usuarios (Cargo, Usuario, Contrasena) " +
